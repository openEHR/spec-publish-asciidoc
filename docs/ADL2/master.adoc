...
:description: Archetype Definition Language (AOM2) specification
...
// the 'a' in the line below is a hack to allow 'all' asciidoc para types in a table
// so that bullet lists etc will work - but it kills prevailing CSS styles like font etc
