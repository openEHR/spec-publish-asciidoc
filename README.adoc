...
* proper definition of specific paragraph styles
* control PDF publishing properly
* port approach to openEHR specification-XX repositories
* sort out command line invocation and continuous build
